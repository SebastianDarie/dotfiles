...
local function retrieve_workspace_data(window)
	...
	for _, tab in ipairs(window:mux_window():tabs()) do
		...
		for _, pane_info in ipairs(tab:panes_with_info()) do
			wezterm.log_info(pane_info.pane:get_foreground_process_info())
	...
	-- wezterm.log_info(workspace_data)
...
local function recreate_workspace(window, workspace_data)
	...
	wezterm.log_info(foreground_process)
	wezterm.log_info(initial_pane:get_foreground_process_info())
